...
class Goods extends Base {
    ...
    public function addEditCategory(){
            ...
            if(I('is_ajax') == 1)
            {
                ...
                {                          
                    ...
                    $sameCateWhere = ['parent_id'=>$par_id , 'mobile_name'=>$GoodsCategory['mobile_name']];
    ...
    public function addEditGoods()
    {
        ...
        $cat_list = Db::name('goods_category')->where("parent_id = 0 and is_del=1")->select(); // 已经改成联动菜单
    ...
    public  function addEditBrand(){
            ...
            if(IS_POST)
            {
                ...
                $this->ajaxReturn(['status'=>1,'msg'=>'操作成功','result'=>null]);
            }           
